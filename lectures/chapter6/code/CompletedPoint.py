...
########################################################################
    def normalize(self):
        ...
        # compute the distance from point to the origin
...
########################################################################
    def __mul__(self, other):
        ...
        Returns
        [Point/float] - depending on the type of other, returns this 
                point multiplied by other if other is an int/float
